                ...
                <div className="p-6 md:p-7 flex flex-col h-full">
                    ...
                    <div className="mt-auto flex flex-wrap gap-2">
                        <a
                            ...
                            className="w-fit inline-flex items-center gap-2 text-sm font-medium text-near-black bg-warm-sand/40 hover:bg-warm-sand rounded-full px-5 py-2 transition-all ring-warm hover:ring-terracotta"
                        >
